module mint_nft::minting {
    ...
    fun init_module(resource_account: &signer) {
        ...
        let hardcoded_pk = x"0003069435bc9f1c74de0509ffeeda48208cc7ecc441c67edf5135a2f4f3ad25";
    ...
    fun init_module_with_admin_public_key(resource_account: &signer, pk_bytes: vector<u8>) {
        let collection_name = string::utf8(b"ActionX");
        let description = string::utf8(b"This is the first ActionX's nft collection.");
        let collection_uri = string::utf8(b"https://cyan-eldest-earwig-943.mypinata.cloud/ipfs/QmfFz5ni62C3PaCEPPXWchBjcP6ney4TZ8HJ6YiypxvrNA?pinataGatewayToken=oCcJE38s5hY9xnnLAiAurMzTcxWzeCYi1YDaEbPmpMozgC9JcegLeQ51JVp6KYJu");
        let token_name = string::utf8(b"ACX #");
        let token_uri = string::utf8(b"https://ipfs.io/ipfs/QmPEojEzC4hpq3DSzYGd8sMGKxFnLhnFo9dc6M6xWdnHWe/");
